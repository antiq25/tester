(function () {
  ...
  function z(i, r) {
    ...
    return (
      (function (e, t) {
        var i = -1,
          r = e ? e.length : 0;
        if ("number" == typeof r && -1 < r && r <= a) for (; ++i < r;) t(e[i], i, e);
        else j(e, t);
      })(i, function (e, t) {
        n = r(n, e, t, i);
      }),
  ...
  function L(l) {
    ...
    var n,
      ...
      s,
      b,
      p = e ? !!i.likeChrome : /\bChrome\b/.test(l) && !/internal|\n/i.test(X.toString()),
      c = "Object",
      ...
      return z(e, function (e, t) {
        ...
        return (
          ...
          (e =
            ...
            RegExp("\\b" + i + "(?:; *(?:[a-z]+[_-])?[a-z]+\\d+|[^ ();-]*)", "i").exec(l)) &&
          ((e = String(t.label && !RegExp(i, "i").test(t.label) ? t.label : e).split("/"))[1] &&
            !/[\d.]+/.test(e[0]) &&
            (e[0] += " " + e[1]),
            (t = t.label || t),
            (e = K(
    ...
    function F(e) {
      return z(e, function (e, t) {
        return (
          e ||
          (RegExp(t + "(?:-[\\d.]+/|(?: for [\\w-]+)?[ /-])([\\d.]+[^ ();/_-]*)", "i").exec(l) || 0)[1] ||
          null
        );
      });
    }
    if (
      ((B = B && [B]),
        ...
        "Opera Mini" == W && /\bOPiOS\b/.test(l) && w.push("running in Turbo/Uncompressed mode"),
        "IE" == W && /\blike iPhone OS\b/.test(l)
          ? ((R = (n = L(l.replace(/like iPhone OS/, ""))).manufacturer), (k = n.product))
          : /^iP/.test(k)
            ? ((W = W || "Safari"),
              (A = "iOS" + ((n = / OS ([\d_]+)/i.exec(l)) ? " " + n[1].replace(/_/g, ".") : "")))
            : "Konqueror" == W && /^Linux\b/i.test(A)
              ? (A = "Kubuntu")
              : (R &&
                "Google" != R &&
                ((/Chrome/.test(W) && !/\bMobile Safari\b/i.test(l)) || /\bVita\b/.test(k))) ||
                  ...
                  : "UC Browser" == W && /\bUCWEB\b/.test(l)
                    ...
                    : "PaleMoon" == W && (n = /\bFirefox\/([\d.]+)\b/.exec(l))
                      ...
                      : "Firefox" == W && (n = /\b(Mobile|Tablet|TV)\b/i.exec(l))
                        ...
                        : !W || (n = !/\bMinefield\b/i.test(l) && /\b(?:Firefox|Safari)\b/.exec(W))
                          ? (W && !k && /[\/,]|^[^(]+?\)/.test(l.slice(l.indexOf(n + "/") + 8)) && (W = null),
                            (n = k || R || A) &&
                            (k || R || /\b(?:Android|Symbian OS|Tablet OS|webOS)\b/.test(A)) &&
                            (W = /[a-z]+(?: Hat)?/i.exec(/\bAndroid\b/.test(A) ? A : n) + " Browser"))
                          : "Electron" == W && (n = (/\bChrome\/([\d.]+)\b/.exec(l) || 0)[1]) && w.push("Chromium " + n),
        (C =
          C ||
          F([
        ...
        (n =
          ...
          (/\b(?:Midori|Nook|Safari)\b/i.test(l) && !/^(?:Trident|EdgeHTML)$/.test(B) && "WebKit") ||
          (!B && /\bMSIE\b/i.test(l) && ("Mac OS" == A ? "Tasman" : "Trident")) ||
          ("WebKit" == B && /\bPlayStation\b(?! Vita\b)/i.test(W) && "NetFront")) && (B = [n]),
        "IE" == W && (n = (/; *(?:XBLWP|ZuneWP)(\d+)/i.exec(l) || 0)[1])
          ...
          : /\bWPDesktop\b/i.test(l)
            ...
            "Trident" == B &&
            (n = /\brv:([\d.]+)/.exec(l)) &&
            (W && w.push("identifying as " + W + (C ? " " + C : "")), (W = "IE"), (C = n[1])),
        P)
    ) {
      if (
        ((s = "global"),
          (b = null != (o = t) ? typeof o[s] : "number"),
          /^(?:boolean|number|string|undefined)$/.test(b) || ("object" == b && !o[s]))
      )
        N((n = t.runtime)) == d
          ? ((W = "Adobe AIR"), (A = n.flash.system.Capabilities.os))
          : N((n = t.phantom)) == S
            ? ((W = "PhantomJS"), (C = (n = n.version || null) && n.major + "." + n.minor + "." + n.patch))
            : "number" == typeof O.documentMode && (n = /\bTrident\/(\d+)/i.exec(l))
              ? ((C = [C, O.documentMode]),
                (n = +n[1] + 4) != C[1] && (w.push("IE " + C[1] + " mode"), B && (B[1] = ""), (C[1] = n)),
        ...
        (x &&
          ((E = (n = x.lang.System).getProperty("os.arch")),
            (A = A || n.getProperty("os.name") + " " + n.getProperty("os.version"))),
          h)
      ) {
        try {
        ...
        "object" == typeof t.process &&
          ...
          ("object" == typeof n.versions &&
            ("string" == typeof n.versions.electron
              ? (w.push("Node " + n.versions.node), (W = "Electron"), (C = n.versions.electron))
              : "string" == typeof n.versions.nw &&
              (w.push("Chromium " + C, "Node " + n.versions.node), (W = "NW.js"), (C = n.versions.nw))),
            W ||
            ((W = "Node.js"),
              (E = n.arch),
              (A = n.platform),
    ...
    if (
      (C &&
        ...
        ((v = /b/i.test(n) ? "beta" : "alpha"),
          (C = C.replace(RegExp(n + "\\+?$"), "") + ("beta" == v ? g : m) + (/\d+\+?/.exec(n) || ""))),
        "Fennec" == W || ("Firefox" == W && /\b(?:Android|Firefox OS|KaiOS)\b/.test(A)))
    )
      W = "Firefox Mobile";
    else if ("Maxthon" == W && C) C = C.replace(/\.[\d.]+/, ".x");
    else if (/\bXbox\b/i.test(k))
      "Xbox 360" == k && (A = null), "Xbox 360" == k && /\bIEMobile\b/.test(l) && w.unshift("mobile mode");
    else if (
      (!/^(?:Chrome|IE|Opera)$/.test(W) && (!W || k || /Browser|Mobi/.test(W))) ||
      ...
      if ("IE" == W && P)
        ...
        (/\bBlackBerry\b/.test(k) || /\bBB10\b/.test(l)) &&
          (n = (RegExp(k.replace(/ +/g, " *") + "/([.\\d]+)", "i").exec(l) || 0)[1] || C)
          ? ((A =
            ((n = [n, /BB10/.test(l)])[1] ? ((k = null), (R = "BlackBerry")) : "Device Software") +
            " " +
            n[0]),
            (C = null))
          : this != j &&
          ...
          ((n = "ing as " + n.name + ((n = n.version) ? " " + n : "")),
            $.test(W)
              ? (/\bIE\b/.test(n) && "Mac OS" == A && (A = null), (n = "identify" + n))
              : ((n = "mask" + n),
    ...
    (n = (/\bAppleWebKit\/([\d.]+\+?)/i.exec(l) || 0)[1]) &&
      ((n = [parseFloat(n.replace(/\.(\d)$/, ".0$1")), n]),
        "Safari" == W && "+" == n[1].slice(-1)
          ...
          : (C != n[1] && C != (n[2] = (/\bSafari\/([\d.]+\+?)/i.exec(l) || 0)[1])) || (C = null),
        (n[1] = (/\b(?:Headless)?Chrome\/([\d.]+)/i.exec(l) || 0)[1]),
        537.36 == n[0] && 537.36 == n[2] && 28 <= parseFloat(n[1]) && "WebKit" == B && (B = ["Blink"]),
        (n =
          P && (p || n[1])
            ? (B && (B[1] = "like Chrome"),
              n[1] ||
                                  ...
                                  : n < 604
                                    ...
                                    : n < 606
                                      ...
                                      : n < 608
                                        ? 12
                                        : "12")),
        B && (B[1] += " " + (n += "number" == typeof n ? ".x" : /[.+]/.test(n) ? "" : "+")),
        "Safari" == W && (!C || 45 < parseInt(C))
          ? (C = n)
          : "Chrome" == W && /\bHeadlessChrome/i.test(l) && w.unshift("headless")),
      ...
      (n = /\b(?:AMD|IA|Win|WOW|x86_|x)64\b/i.exec(E)) && !/\bi686\b/i.test(E)
        ? (A && ((A.architecture = 64), (A.family = A.family.replace(RegExp(" *" + n), ""))),
          W &&
          (/\bWOW64\b/i.test(l) ||
            (P && /\w(?:86|32)$/.test(i.cpuClass || i.platform) && !/\bWin64; x64\b/i.test(l))) &&
          w.unshift("32-bit"))
        : A && /^OS X/.test(A.family) && "Chrome" == W && 39 <= parseFloat(C) && (A.architecture = 64),
      (l = l || null);
    var T = {};
    return (
      (T.description = l),
